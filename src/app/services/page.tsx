...
const SERVICES = [
  ...
  { t: "Staff Outsourcing", d: "Talent matched to your business needs through HR management systems, compliant and operationally efficient." },
];
const SvcIcon = () => (
...
export default function Services() {
  return (
    <div>
      <section className="banner"><div className="wrap"><div className="crumb">Home <b>›</b> Our Services</div><h1>Our Services</h1><p>The full range of technology-enabled audit, tax, accounting and advisory services, compliant with Nigerian and international standards.</p></div></section>
